...
{
    static const ShaderSources sSources = {UNLIT_COLOR_VS, UNLIT_COLOR_FS};
    return sSources;
}

const ShaderSources& UnlitTexture()
{
    static const ShaderSources sSources = {UNLIT_TEXTURE_VS, UNLIT_TEXTURE_FS};
    return sSources;
}

const ShaderSources& Starfield()
{
    static const ShaderSources sSources = {STARFIELD_VS, STARFIELD_FS};
    return sSources;
}
